...
- **social-pressure** глобальна змінна соціаільного тиску яка впливає на шанс зникання агента.
...
to update-vanish-prob
  ask turtles [
    ...
    set vanish-prob vanish-prob * (1 + social-pressure)
    set vanish-prob min list vanish-prob 1
  ]
end
...
<table border="1" cellpadding="6" cellspacing="0">
  <thead>
    <tr>
      <th>Кількість агентів</th>
      <th>Кількість тактів</th>
      <th>Процент схожості (%)</th>
      <th>Остаточна кількість агентів</th>
    </tr>
  </thead>
  <tbody>
    <tr>
